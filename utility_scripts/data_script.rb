...
#Create Users
U1 = User.create(:phone => '1111111111', :password => '123456', :name => 'Tyrion', :session_token => 'abcdefgh1')
U1.photo = File.new("#{Rails.root}/images/GOT/Tyrion.jpg")
U1.save

U2 = User.create(:phone => '2222222222', :password => '123456', :name => 'Jon', :session_token => 'abcdefgh2')
U2.photo = File.new("#{Rails.root}/images/GOT/snow.jpg")
U2.save

U3 = User.create(:phone => '3333333333', :password => '123456', :name => 'Sansa', :session_token => 'abcdefgh3')
U3.photo = File.new("#{Rails.root}/images/GOT/sansa.jpg")
U3.save

U4 = User.create(:phone => '4444444444', :password => '123456', :name => 'Bran', :session_token => 'abcdefgh4')
U4.photo = File.new("#{Rails.root}/images/GOT/bran.jpg")
U4.save

U5 = User.create(:phone => '5555555555', :password => '123456', :name => 'Arya', :session_token => 'abcdefgh5')
U5.photo = File.new("#{Rails.root}/images/GOT/arya.png")
U5.save

U6 = User.create(:phone => '6666666666', :password => '123456', :name => 'Cersei', :session_token => 'abcdefgh6')
U6.photo = File.new("#{Rails.root}/images/GOT/cersei.jpg")
U6.save

U7 = User.create(:phone => '7777777777', :password => '123456', :name => 'Daenerys', :session_token => 'abcdefgh7')
U7.photo = File.new("#{Rails.root}/images/GOT/daenerys.jpg")
U7.save

U8 = User.create(:phone => '8888888888', :password => '123456', :name => 'Hodor', :session_token => 'abcdefgh8')
U8.photo = File.new("#{Rails.root}/images/GOT/hodor.jpg")
U8.save

U9 = User.create(:phone => '9999999999', :password => '123456', :name => 'Jaime', :session_token => 'abcdefgh9')
